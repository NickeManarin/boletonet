...
namespace BoletoNet
{
    ...
    public class Sacado
    {
        ...
        private readonly InformacoesSacado _info = new InformacoesSacado();//Flavio(fhlviana@hotmail.com) - lista de todas as informações para serem apresentadas abaixo do nome do sacado
        ...
        public string CpfCnpj
        {
            ...
            set
            {
                ...
                var o = value.Trim().Replace(".", "").Replace("-", "").Replace("/", "");
                ...
                if (string.IsNullOrEmpty(o))//Flavio(fhlviana@hotmail.com) - em razao da adiçao da possibilidade do boleto nao apresentar CPF ou CNPJ na renderização
